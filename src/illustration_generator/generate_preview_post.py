...
Usage::
    ...
    python generate_preview_post.py data/06_July
    python generate_preview_post.py data/06_July/06_july.md data/06_July/illustration_2.png
    python generate_preview_post.py data/06_July --compare data/17.jpg
"""
